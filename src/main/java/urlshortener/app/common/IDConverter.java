...
public class IDConverter {
    ...
    private static final Hashids HASHIDS = new Hashids("this is my salt", 8);
    ...
    public static String createUniqueID(Long id) {
        ...
        String uniqueURLID = HASHIDS.encode(id);
        return uniqueURLID;
    ...
    public static Long getDictionaryKeyFromUniqueID(String uniqueID) {
        ...
        long[] dictionaryKeys = HASHIDS.decode(uniqueID);

        if (dictionaryKeys.length > 0) {
            return dictionaryKeys[0];
        } else {
            return 0L;
        }
